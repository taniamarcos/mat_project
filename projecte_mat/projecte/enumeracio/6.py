...
while not salir:
    ...
    if opcion == 1:
       ...
       userlist = input()
       print ("---------------------------------------")
       call(["enumeracio/enum4linux.pl","-U",userlist])
       print("---------------------------------------")
       print ("")
    elif opcion == 2:
       print ("")
       ...
       pclist = input()
       print ("---------------------------------------")
       call(["enumeracio/enum4linux.pl","-M",pclist])
       print ("---------------------------------------")
       print ("")
    elif opcion == 3:
       print ("")
       ...
       sharelist = input()
       print ("---------------------------------------")
       call(["enumeracio/enum4linux.pl","-P",sharelist])
       print ("---------------------------------------")
       print ("")
    elif opcion == 4:
       print ("")
       ...
       sharelist = input()
       print ("---------------------------------------")
       call(["enumeracio/enum4linux.pl","-S",sharelist])
       print ("---------------------------------------")
       print ("")
    elif opcion == 5:
       print ("")
       ...
       print ("---------------------------------------")
       gim = input()
       call(["enumeracio/enum4linux.pl","-G",gim])
       print ("---------------------------------------")
       print ("")
    elif opcion == 6:
       print ("Personalitzat")
       ...
       ip = input()
       print ("---------------------------------------")
       call(["enumeracio/enum4linux.pl",perso,ip])
       print ("---------------------------------------")
       print ("")
    elif opcion == 7:
       salir = True
